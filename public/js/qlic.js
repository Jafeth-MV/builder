(function(){
  ...
  const translations = {
    ...
    es: {
      ...
      'cards.volumeTitle':'Volume Management','cards.volumeText':'Registra niveles, calcula consumos y predice reabastecimientos.',
      'cards.pressureTitle':'Pressure Tracking','cards.pressureText':'Detecta variaciones de presión para evitar daños en líneas.',
      'cards.temperatureTitle':'Temperature Control','cards.temperatureText':'Asegura rangos ideales con alertas inteligentes.',
      'about.title':'Nosotros','about.desc':'En Qlic construimos tecnología de sensores y software para dar visibilidad total al uso de líquidos. Creemos en datos precisos, alertas útiles y simplicidad operativa.',
      'about.missionTitle':'Misión','about.missionText':'Hacer que la gestión de líquidos sea predecible y eficiente.',
      ...
      'solutions.title':'Soluciones por segmento','solutions.homeTitle':'Residencias','solutions.homeText':'Monitorea tinacos y cisternas, recibe alertas de bajo nivel y evita fugas.',
      'solutions.businessTitle':'Negocios','solutions.businessText':'Controla inventarios de líquidos, auditorías y cumplimiento en industrias.',
      'features.title':'Funcionalidades clave','features.pressureTitle':'Pressure Tracking','features.pressureText':'Tendencias y umbrales de seguridad con notificaciones.',
      'features.temperatureTitle':'Temperature Control','features.temperatureText':'Rangos personalizados y control térmico para calidad.',
      'features.volumeTitle':'Volume Management','features.volumeText':'Proyecciones de consumo y logística de reabastecimiento.',
      'pricing.title':'Planes de suscripción','pricing.perMonth':'/mes','pricing.recommended':'Recomendado','pricing.choose':'Choose Plan','pricing.custom':'Custom',
      ...
      'faq.title':'Preguntas frecuentes','faq.q1':'¿Qué líquidos puedo monitorear?','faq.a1':'Agua, cerveza, combustibles y otros líquidos compatibles con nuestros sensores.',
      ...
      'contact.title':'Contact Sales','contact.desc':'Cuéntanos sobre tu operación y un especialista te contactará.',
