(function(){
  ...
  const translations = {
    en: {
      ...
      'faq.title':'Frequently asked questions','faq.q1':'What can I monitor?','faq.a1':'Water tanks, cisterns and distribution lines compatible with our sensors.',
    ...
    es: {
      ...
      'testimonials.desc':'Historias reales de equipos que usan Qlic para el agua.',
      'testimonials.1.quote':'Por fin tenemos visibilidad total de nuestros tanques de agua. Las alertas evitaron dos cortes el mes pasado.',
      'testimonials.1.name':'Laura P.','testimonials.1.role':'Jefa de instalaciones',
      'testimonials.2.quote':'La implementación fue sencilla y los paneles son claros. El soporte también es excelente.',
      'testimonials.2.name':'Daniel R.','testimonials.2.role':'Gerente de Operaciones',
      'testimonials.3.quote':'Reducimos el desperdicio de agua en 18% tras un trimestre usando Qlic.',
      'testimonials.3.name':'María G.','testimonials.3.role':'Supervisora de planta',
